...
- Add possibility to process resting-state data via
  [`fixed_length_epochs_duration`][config.fixed_length_epochs_duration] and
  [`fixed_length_epochs_overlap`][config.fixed_length_epochs_overlap].
  ({{ gh(393) }} by {{ authors.dengemann }})
